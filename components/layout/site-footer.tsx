...
const socialLinks = [
  {
    label: 'Instagram',
    href: 'https://instagram.com/xolaceinc',
    icon: (
  ...
  {
    label: 'LinkedIn',
    href: 'https://linkedin.com/company/xolace',
    icon: (
      <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current">
...
export function SiteFooter() {
  return (
    <footer className="w-full bg-primary px-4 pt-4 pb-2 md:px-24 md:pt-24 md:pb-8">
      <div className="flex flex-col gap-8">
        ...
        <div className="border-t border-secondary/60 my-8" />
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
            ...
            <div className="hidden flex-col items-end gap-3 md:flex">
              <span className="text-[14px] font-medium text-primary-foreground/90">
                Get the app
              </span>
          ...
          <div className="border-primary-foreground/20 pt-4">
